 ...
 */
function wmg_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _wmg_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function wmg_html_head_alter(&$head_elements) {
...
function wmg_preprocess_page(&$variables) {
 ...
 */
function wmg_preprocess_block(&$vars) {
 ...
 */
function _wmg_variable_get($key, $default) {
  global $theme;
 ...
 */
function _wmg_get_layout() {
  $layout_patterns = _wmg_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function wmg_node_view_alter(&$build) {
...
function wmg_preprocess_forum_topic_list(&$vars) {
 ...
 */
function wmg_preprocess_comment_wrapper(&$vars) {
 ...
 */
function wmg_preprocess_media_gallery_license(&$vars) {
 ...
 */
function wmg_date_combo($variables) {
