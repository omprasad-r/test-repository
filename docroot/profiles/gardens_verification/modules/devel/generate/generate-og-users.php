...
// $Id: generate-og-users.php,v 1.5 2009/12/02 23:44:03 yched Exp $:
...
foreach ($groups as $nid => $group) {
  $node = node_load($nid);
  drupal_set_message(t('Assigned %n users to group %t.', array('%n' => $users, '%t' => theme('placeholder', $node->title[LANGUAGE_NONE][0]['value']))));
