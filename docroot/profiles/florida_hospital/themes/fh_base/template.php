 ...
 */
function fh_base_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _fh_base_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function fh_base_html_head_alter(&$head_elements) {
...
function fh_base_preprocess_page(&$variables) {
  ...
  $layoutClass = _fh_base_get_layout();
 ...
 */
function fh_base_preprocess_block(&$vars) {
 ...
 */
function _fh_base_variable_get($key, $default) {
  global $theme;
 ...
 */
function _fh_base_get_layout() {
  $layout_patterns = _fh_base_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function fh_base_node_view_alter(&$build) {
...
function fh_base_preprocess_forum_topic_list(&$vars) {
 ...
 */
function fh_base_preprocess_comment_wrapper(&$vars) {
