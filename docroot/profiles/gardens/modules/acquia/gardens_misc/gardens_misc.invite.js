 ...
 */
Drupal.behaviors.gardensMiscInvitationMessage = {
  attach: function(context) {
    $('.form-item-invitation-message', context).once('gardens-misc-invitation-message', function () {
      ...
      $textarea_wrapper.prepend('<a href="#" id="gardens-misc-toggle-invitation-message">' + showMessageLinkText + '</a>');
      $textarea.hide();
      ...
      // appearance.
      var $toggle_link = $('#gardens-misc-toggle-invitation-message', $textarea_wrapper);
